...
type Body = { lock_key?: unknown };
type ReleaseResponse = { lock_key?: unknown; changed?: unknown; replayed?: unknown };
...
export async function POST(request: Request) {
  ...
  const gas = await callGas<ReleaseResponse>("locks.release", { lock_key: str(body.lock_key) }, requestId);
