...
export async function POST(request: Request) {
  ...
  const gas = await callGas<ReleaseResp>("inventory.release", { sku_id: skuId, location_id: locationId, qty, expected_version_id: expectedVersionId, reason, proof_ref: proofRef }, auth.requestId);
