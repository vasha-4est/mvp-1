...
const ALLOWED_EVENT_TYPES = new Set<string>([
  ...
  "picking_list_closed",
  "shipment_created",
  "shipment_plan_import_started",
  "shipment_plan_import_validated",
  "shipment_plan_import_committed",
  "shipment_plan_import_replayed",
  "shipment_plan_import_failed",
  "shipment_updated",
  "shipment_ready",
  "shipment_confirmed",
  "shipment_shipped",
