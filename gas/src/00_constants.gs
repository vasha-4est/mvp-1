...
const SHEET_DB = {
  ...
  [SHEET.SKU]: DB.OPS,
  [SHEET.SKU_BOM]: DB.OPS,
  [SHEET.INVENTORY]: DB.OPS,
  [SHEET.INVENTORY_MOVES]: DB.OPS,
...
const ERROR = {
  ...
  CONTROL_MODEL_SHEET_INVALID: 'CONTROL_MODEL_SHEET_INVALID',
  INVALID_PRODUCTS_SKU_SCHEMA: 'INVALID_PRODUCTS_SKU_SCHEMA',
